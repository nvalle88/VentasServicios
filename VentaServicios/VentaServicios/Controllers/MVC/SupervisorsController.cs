...
namespace VentaServicios.Controllers.MVC
{
    public class SupervisorsController : Controller
    {
        ...
        {
            var supervisor = db.Supervisor.Include(s => s.Gerente).Include(s => s.Usuario);
        ...
        {
            ViewBag.IdGerente = new SelectList(db.Gerente, "IdGerente", "IdGerente");
        ...
        public async Task<ActionResult> Create([Bind(Include = "IdSupervisor,IdUsuario,IdGerente")] Supervisor supervisor)
        {
            ...
            ViewBag.IdGerente = new SelectList(db.Gerente, "IdGerente", "IdGerente", supervisor.IdGerente);
            ViewBag.IdUsuario = new SelectList(db.Usuario, "IdUsuario", "TokenContrasena", supervisor.IdUsuario);
            return View(supervisor);
        }
